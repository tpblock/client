...
var jsonToRawAbi = Api.prototype.jsonToRawAbi;
Api.prototype.jsonToRawAbi = function(abi) {
    if (abi.version && abi.version === 'eosio::abi/1.0')
        return jsonToRawAbi.call(this, abi);
