...
Api.prototype.abi_definition = function(abi) {
    var abiDefinitions = this.abiTypes.get('abi_def');
    return abiDefinitions.fields.reduce(
        (acc, { name: fieldName }) =>
...
Api.prototype.serialize_abi = function(abi) {
    let _abi = this.abi_definition(abi);
    return encoding.hex.encode(this.jsonToRawAbi(_abi));
}